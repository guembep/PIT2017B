...
function nuevoejercicio(){
	...
	$("#contenido").load("./Form_CrearEjercicio.html", function(responseTxt, statusTxt, xhr){
		...
		//	nuevoscript.setAttribute("type","text/javascript");
			nuevoscript.setAttribute("src","pizarra/watch.js");
			$("#contenido").append(nuevoscript);
            var nuevoscript = document.createElement( "script" );
		//	nuevoscript.setAttribute("type","text/javascript");
			nuevoscript.setAttribute("src","pizarra/jquery-2.js");
			$("#contenido").append(nuevoscript);
            var nuevoscript = document.createElement( "script" );
		//	nuevoscript.setAttribute("type","text/javascript");
			nuevoscript.setAttribute("src","pizarra/jquery.js");
			$("#contenido").append(nuevoscript);
            var nuevoscript = document.createElement( "script" );
		//	nuevoscript.setAttribute("type","text/javascript");
			nuevoscript.setAttribute("src","pizarra/1.js");
			$("#contenido").append(nuevoscript);
			var nuevoscript = document.createElement( "script" );
		//	nuevoscript.setAttribute("type","text/javascript");
			nuevoscript.setAttribute("src","pizarra/2.js");
			$("#contenido").append(nuevoscript);
		    var nuevoscript = document.createElement( "script" );
		//	nuevoscript.setAttribute("type","text/javascript");
			nuevoscript.setAttribute("src","pizarra/markup_handball.js");
			$("#contenido").append(nuevoscript);	
            var nuevoscript = document.createElement( "script" );
		//	nuevoscript.setAttribute("type","text/javascript");
