<?php
	...
	if(isset($_SESSION['id'])){
		...
		$stmt = $db->prepare("UPDATE ejercicios SET deporte=?, idequipo=?, categoria=?, subcategoria=?, nombre=?, explicacion=?, duracion=?, material=?, personasmin=?, personasmax=?, foto=? , idusuario=? , datospizarra=? WHERE id=? ");
